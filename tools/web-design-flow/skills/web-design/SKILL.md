---
name: web-design
description: Coordinate the design stage between prototype and build for web projects. Use when Codex needs to prepare, organize, review, or gate design handoff materials before development, including guiding designers on submission format, checking whether a design should go to build, or routing to design handoff review.
---

# Web Design

Manage the design stage between product intent and code. The goal is a development-ready design handoff, not a visual taste review or code implementation.
